...
const Footer = () => {
  ...
  useEffect(() => {
    const fetchServices = async () => {
      try {
        const res = await fetch('https://Forensix-dash.netlify.app/api/project');
  ...
  return (
    <footer className="bg-[#0b2556] text-[#fff] py-10 px-4">
   ...
   <a href="https://x.com/ForensixAi?t=JR2uAHSwoXLnTs21vsZRMw&s=08" target="_blank" rel="noopener noreferrer">
    <FaTwitter className="text-[#fff] cursor-pointer" />
        ...
        <div className="text-center mt-10 mb-20">
          <p className="text-sm uppercase">Forensix 2025 ALL RIGHTS RESERVED</p>
        </div>
      </div>
